...
class __TwigTemplate_7363d8195cc8fa8c5ba83b5abc648119903d2199256232302611228f6e7a71e1 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<a href=\"";
            // line 19
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog", ["id" => twig_get_attribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 19)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "Name", [], "any", false, false, false, 19), "html", null, true);
            echo "</a>
\t\t\t\t</th>
\t\t\t\t<th>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "Category", [], "any", false, false, false, 21), "html", null, true);
            echo "</th>
\t\t\t</tr>
\t\t";
        }
...
";
    ...
    {
        return array (  123 => 24,  114 => 21,  107 => 19,  103 => 17,  99 => 16,  89 => 8,  79 => 7,  59 => 3,  36 => 1,);
    }
...
\t</table>
{% endblock %}
", "blog/index.html.twig", "D:\\ProjectProgram\\Test.Blog\\templates\\blog\\index.html.twig");
    }
}
